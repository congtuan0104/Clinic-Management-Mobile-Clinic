...
export default function StaffDashboardScreen({
  ...
  route,
    ...
    const onChangeTextHandler = (query: string) => {
        console.log(query); // In ra giá trị của text hiện tại trong Searchbar
  ...
  return (
    ...
    >
        <Searchbar
            ...
            value={searchQuery}
            inputStyle={{ paddingBottom: 20, paddingTop: 5 }}
        />
      ...
      {clinicServiceList?.length ? (
        <>
          ...
          <ScrollView>
            <VStack space={5}>
                {searchFilterList.length? searchFilterList.map((serviceItem: IClinicService, index: number) => {
                return (
                  <Box
                    borderRadius={20}
                  ...
                  >
                    <HStack justifyContent="space-between" alignItems="center">
                      ...
                      <HStack space={2} alignItems="center">                   
                        <Pressable
                            onPress={() => handleOpenUpdateModal(serviceItem)}
                        >
                            <FontAwesome5
                            name="edit"
                            size={18}
                    ...
                    <HStack space={4} mt={2}>
                      ...
                      <VStack>
                        ...
                        <Text color={appColor.textSecondary}>
                          {serviceItem.isDisabled ? "Không hoạt động" : "Đang hoạt động"}
                        </Text>
                      </VStack>
                    </HStack>
                  </Box>
              ...
              clinicServiceList.map((serviceItem: IClinicService, index: number) => {
                return (
                  <Box
                    borderRadius={20}
                    backgroundColor={appColor.background}
