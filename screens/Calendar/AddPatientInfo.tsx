import {
  ...
  const AddPatientInfo: React.FC<AddPatientInfoProps> = ({ setIsAddPatientInfo }) => {
    ...
    return (
      <>
        ...
        >
          ...
          <ScrollView minWidth="100%" maxWidth="100%" persistentScrollbar={true} nestedScrollEnabled = {true}>
            <VStack space={5}>
              <VStack space={5}>
                  ...
                  <Controller
                    ...
                    render={({ field: { onChange, onBlur, value } }) => (
                      <SelectDropdown
                        ...
                        renderDropdownIcon={() => <Image source={chevronDown} size={18}/>}
